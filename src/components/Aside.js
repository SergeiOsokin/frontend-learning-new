                    ...
                    {authorization &&
                        <ul className="nav__list">
                            <li className="nav__item">
                                <Link className={`nav__link ${history.location.pathname.includes('flashcards') ? '--th-active' : ''}`} to="/flashcards" id='/flashcards'>
                            ...
                            <li className="nav__item">
                                <Link className={`nav__link ${history.location.pathname.includes('wordslist') ? '--th-active' : ''}`} to="/wordslist">
                                    <svg className="nav__icon" viewBox="0 0 32 32" fill="none">
                                        <path
                            ...
                            <li className="nav__item">
                                <Link className={`nav__link ${history.location.pathname.includes('notes') ? '--th-active' : ''}`} to="/notes">
                                    <svg className="nav__icon" viewBox="0 0 32 32" fill="none">
                                        <path
                    ...
                    <ul className="nav__list">
                        <li className="nav__item">
                            <Link className="nav__link" to="/registration">
                                ...
                                <span className="nav__text">Регистрация</span>
                            </Link>
                        </li>
                        <li className="nav__item">
                            <Link className="nav__link" to="/authorization">
                                <svg className="nav__icon" viewBox="0 0 32 32" fill="none">
                                    <path
                                        d="M26.6654 15.9999H10.6654M26.6654 15.9999L21.332 21.3333M26.6654 15.9999L21.332 10.6666M11.9987 5.33325H9.33203C8.27117 5.33325 7.25375 5.75468 6.5036 6.50482C5.75346 7.25497 5.33203 8.27239 5.33203 9.33325V22.6666C5.33203 23.7275 5.75346 24.7449 6.5036 25.495C7.25375 26.2452 8.27117 26.6666 9.33203 26.6666H11.9987"
                                        stroke="currentColor"
                                ...
                                <span className="nav__text">Войти</span>
                            </Link>
                        </li>
                    </ul>
                </nav>
