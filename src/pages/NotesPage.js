                        ...
                        <section className="app-cards">
                            ...
                            <ul className="app-cards__inner">
                                ...
                                {notes
                                    ...
                                    .map((note, index) => {
                                        return (
                                            <li className="app-cards__item" key={index + note.id}>
                            ...
                            {/* <ul className="app-cards__inner">
                                ...
                                <li className="app-cards__item">
                                    <div className="card card-note">
                                        ...
                                        <div className="card-note__content">
                                            <h3 className="card-note__title">Would like</h3>
                                            <p className="card-note__text">
                                                Является вежливым способом сказать “I want” я хочу
                                                по-английски. Если сказать I want, то это будет звучать по
                                                детски или грубо.
                                            </p>
                                        </div>
                                    </div>
